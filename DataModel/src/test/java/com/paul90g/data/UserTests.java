...
class UserTests {
    ...
    private static final String PASSWORD = "passrowd";
    ...
    void testUserBadEmail() {
        ...
        Executable exec = () -> {
            new User(USERNAME, FIRST_NAME, LAST_NAME, PASSWORD, BAD_EMAIL);
        };
    ...
    void testUserBadUsername() {
        ...
        Executable exec = () -> {
            new User(BAD_USERNAME, FIRST_NAME, LAST_NAME, PASSWORD, EMAIL);
        };
        assertThrows(InvalidDataException.class, exec);
        log.info("Test OK");
    }
